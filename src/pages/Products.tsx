...
const Products = () => {
  ...
  return <div className="min-h-screen bg-white dark:bg-gray-900 pt-16">
      <FloatingActionButton />
      <StickyQuoteBar />
      
      <div className="container mx-auto px-[17px] py-0">
        <ProductsHeader title={activeGroup === "all" ? t('products_page_title') : activeGroup} totalResults={filteredProducts.length} />
        
        <ProductsFilters searchQuery={searchQuery} onSearchChange={setSearchQuery} activeGroup={activeGroup} onGroupChange={setActiveGroup} groups={productGroups} onClearFilters={handleClearFilters} hasActiveFilters={searchQuery !== "" || activeGroup !== "all"} />
