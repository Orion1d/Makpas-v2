              ...
              <div className="space-y-8">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <a 
                    ...
                    className="hover:text-safety-orange dark:text-gray-100 dark:hover:text-safety-orange transition-colors text-lg"
                  >
                    {t('contact_email')}
                  </a>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full rounded-md border border-gray-500 dark:border-gray-400 bg-transparent px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-safety-orange focus-visible:border-safety-orange focus-visible:ring-offset-1"
                    placeholder={t('enter_your_message') || 'Enter your message here...'}
                    required
                  />
                </div>
