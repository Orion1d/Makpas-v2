...
const Contact = () => {
  ...
  return (
    <div className="min-h-[90vh] pt-20 pb-12 px-4 md:px-6 bg-pattern-waves section-bg-pattern">
      <StickyQuoteBar />
      ...
      <div className="container mx-auto max-w-7xl space-y-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16">
          ...
          >
            {/* Address Card */}
            <ContactInfoCard 
              title={t('our_address') || 'Our Address'}
              icon={<MapPin className="text-safety-orange h-6 w-6" />}
            >
              <div className="space-y-4">
                ...
                <a 
                  ...
                  className="text-safety-orange hover:underline inline-flex items-center gap-1 transition-all duration-200 hover:text-safety-orange/80"
                >
            ...
            <ContactInfoCard 
              ...
              icon={<Phone className="text-safety-orange h-6 w-6" />}
            >
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <Button 
                      variant="link" 
                      className="p-0 h-auto text-safety-orange font-normal text-lg"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-2">
                    <Button 
                      variant="link" 
                      className="p-0 h-auto text-safety-orange font-normal text-lg block"
                    ...
                    <div className="space-y-1">
                      <Button 
                        variant="link" 
                        className="p-0 h-auto text-primary dark:text-gray-300 font-normal text-sm block"
