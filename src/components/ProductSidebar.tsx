      ...
      <div className="flex justify-between items-center mb-2">
        ...
        {(searchQuery || activeGroup !== "all" || activeFilters.length > 0) && (
          <Button 
            ...
            className="text-secondary hover:text-secondary/80 py-0 h-auto"
          >
              ...
              <AccordionContent>
                <div className="space-y-2 py-2">
                  {category.options.map((option) => (
                    <label key={option.id} className="flex items-center space-x-3 py-1 px-1 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer">
