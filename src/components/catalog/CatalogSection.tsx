...
const CatalogSection = () => {
  ...
  return (
    <section className="py-16 bg-white dark:bg-gray-950 transition-all duration-700 ease-in-out">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 max-w-5xl mx-auto">
          ...
          <BlurFade delay={0.2} inView>
            <div className="w-full md:w-1/2 flex justify-center">
              <img 
                ...
                className="rounded-lg shadow-lg transform hover:scale-105 transition-all duration-500 max-w-[300px] w-full"
              />
            </div>
          </BlurFade>
          ...
          <BlurFade delay={0.4} inView>
            <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
              ...
              <Button
                asChild
                className="mt-4 gap-2 bg-secondary hover:bg-secondary/90 transform hover:scale-105 transition-all duration-300"
              >
