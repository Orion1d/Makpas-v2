          ...
          slidesToScroll: 1
            ...
            <CarouselContent className="-ml-2 md:-ml-4">
              {products.map(product => <CarouselItem key={product.id} className="pl-2 md:pl-4 basis-full md:basis-1/2 lg:basis-1/3">
                  <Card className="cursor-pointer group overflow-hidden backdrop-blur-sm bg-white/80 dark:bg-gray-800/80 hover:shadow-xl transition-all duration-500 transform hover:scale-[1.02]" onClick={() => handleProductClick(product.id)}>
