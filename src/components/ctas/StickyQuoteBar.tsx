        ...
        >
          <div className="relative">
            <Button 
              ...
              size="lg" 
              className={`
                bg-safety-orange text-white shadow-lg px-6 py-3 
                flex items-center gap-2 transition-all duration-300
                ${animateAttention ? 'animate-pulse' : ''}
                ${isExpanded ? 'rounded-t-lg rounded-b-none' : 'rounded-lg'}
              `}
            >
              <QuoteIcon className="h-5 w-5" />
              <span>{t('get_quote') || 'Get a Quote'}</span>
              {isProductDetail && (
